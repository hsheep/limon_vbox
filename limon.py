...
# =======================================] virtualbox [===========================================
    ...
    analysis_vm = Virtualbox(host_vbox_guid)
    analysis_vm.set_credentials(analysis_agent_ip, analysis_agent_port)
    analysis_vm.revert_current()
...
if analysis_vm.copytovm(mal_file, analysis_copy_file_path):
    ...
    print "# post file to guest error. exit"
...
# ========================================= if sysdig is not selected , using strace ================================================
